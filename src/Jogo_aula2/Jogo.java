...
public class Jogo
{
    ...
    public static void fase1() {
        ...
        switch (x)
        {
            ...
            case 1: System.out.println("Você adentrou a caverna!");
                ...
                }else if(dado >1 && dado < 11)
                {
                    ...
                    switch (z)
                    {
                        ...
                        case 2:
                                System.out.println("O Alotimantes foje, e você consegue atravessar a caverna sem problemas.");
                        break;
            ...
            case 2: System.out.println("Você escolheu o caminho da DOR!");
