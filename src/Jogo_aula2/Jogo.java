...
public class Jogo {
        ...
        if(re == 0) {
            ...
            if(dado == 1) {
                ...
                System.out.println("1) Se render  -  2) Lutar em desvantagem");
                    switch (emboscada){
                        case 1: System.out.println("Você deixa suas coisas, seu dinheiro, seus pertences.");
                        ...
                        case 2: System.out.println("Você saca sua espada e se prepara para a luta");
                                System.out.println("No momento em que da um passo a frente, antes de perceber você é alvejado por varias flechas.");
                                morte();
                                re = 1;
                                break;

                        default: System.out.println("Uma flecha é disparada e te atinge");
                    }
            }
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Você está vagando por aí em busca de grandes desafios, com este objetivo, foi a floresta sombria, lugar onde existem diversas criaturas.");
